...
/**
 * Service for Youtube membership verification.
 */
public class MemberVerificationService extends ListenerAdapter implements Service {
  ...
  private static final String CONFIG_FILE_PWD = "config/membership_verification.json";

  /**
   * Read configuration file and try getting connecting with Youtube API.
   */
    ...
    if (parser.getCommandSize() > 2) {
      ...
      if (commandName.equals("manual_verify")) {
        ...
        if (parser.getCommandSize() >= 4) {
          ...
          channel.sendMessage(
            "Error: Command requires member discord ID and Youtube channel ID.").queue();
        }
  ...
  public String getServiceMan() {
    return "NAME\n"
        ...
        + "        verify_member\n\n"
        + "DESCRIPTION\n"
        + "        To get the membership role in this discord server, you will "
        + "need to complete the verification process.\n"
        + "        First do >register <user_youtube_channel_id> to bind your "
        + "discord account id to your youtube channel id.\n"
        + "        Note that once your account is binded, you could not change "
        + "it without help from admin.\n"
